...
CREATE TABLE IF NOT EXISTS subscriptions (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    id_subscriber BIGINT NOT NULL, --кто подписан
    id_event_owner BIGINT NOT NULL, --на кого подписан
    status VARCHAR(50) NOT NULL,
...
ALTER TABLE subscriptions ADD FOREIGN KEY (id_subscriber) REFERENCES users(id);
ALTER TABLE subscriptions ADD FOREIGN KEY (id_event_owner) REFERENCES users(id);